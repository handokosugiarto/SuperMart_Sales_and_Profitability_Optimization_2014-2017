...
2. Chairs are the second leading product sub-category after phones. Chairs' revenue have reached $328K in total from 2014 to 2017, contributing 14.3% sales revenue to the total sales revenue. Chairs' sales revenue have grown with a CAGR 7% which was primarily driven by volume sales which was slightly higher with a CAGR 8% than revenue growth. AOV declined with CAGR 6% which indicates that customer spent less per order. Despite less customer spending per order.
