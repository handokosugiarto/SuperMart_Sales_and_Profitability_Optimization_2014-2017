...
5. **Collaborate with marketing department to create loyalty program membership for active and loyal customer segments in order to built customer retention.** This loyalty program membership is expected to maintain customer with lifespan more than 3 months to give them any privilege that will increase spending rate and AOV.
...
7.  **Collaborate with sales and finance department to re-evaluate pricing strategy, discounting strategy, and cost of good sold to improve Central and South regions performance.**
