# SuperMart Sales & Profitability Optimization 2014-2017
...
1. Phones have become the leading revenue contributor from 2014 to 2017, outperforming other sub categories in total Sales. Total Phones sales has reached $330K from 2014 to 2017, representing 14.4% from total sales revenue in 2014 to 2017. Phones sales generated positive sales throughout the period, indicating consistent demand. Phones sales revenue has grown consistently with CAGR 11%, which was primarily driven by volume sales which grew with CAGR 17% (higher than revenue growth). Despite of lower customers spend per order (AOV -8%), the profit grew by 3% which was slower than revenue growth indicating margin compression.
...
2. Chairs are the second leading product sub-category after phones with its revenue have reached $328K in total from 2014 to 2017, contributing 14.3% of total sales revenue. Chairs' sales revenue have grown with a CAGR 7% which was primarily driven by volume sales which was slightly higher with a CAGR 8% than revenue growth. AOV declined with CAGR 6% which indicates that customer spent less per order. Despite less customer spending per order, the profit amount increased slightly by 3% indicating slight margin compression due to slower growth rate than revenue . These indicators also suggest that chair subcategory is relying its growth on volume sales rather than driven by higher customers spending per order. Further investigation such as price discounting and product mixed by price band to identify unnecessary discount and/or shift to higher/lower product mixed.
...
3. Storage's sub category is the third leading product that contributes 10% of the total sales revenue from 2014 to 2017 periods. Storage's revenue has grown with a CAGR 11% which primarily volume driven with a CAGR 15%. Since AOV declined by 5%, customer's spending per order have declined too. Despite declining in average order value,  the profit has grown stronger than revenue with a CAGR 21% which indicating improved  profitability. These indicator suggest that storage subcategory relies its revenue growth on volume sales rather that higher customer spending per order, however the profit caused by this strategy was high with higher profit margin also. Further investigation on product average selling price, price band by product sales volume, and total cost needed to identify strong growth in profit and margin.
